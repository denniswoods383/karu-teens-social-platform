      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold flex items-center justify-center gap-3">
            😊 Mantis
            <span className="text-lg font-normal text-gray-500">(Emotion Reader)</span>
          </h1>
          <p className="text-gray-600 mt-2">Analyze emotional sentiment with empathic powers</p>
        </div>

        <div className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Text to analyze emotions:
            </label>
            <textarea
              value={text}
              onChange={(e) => setText(e.target.value)}
              placeholder="Enter text to analyze emotional sentiment..."
          ...
          >
            {loading ? (
              <>
                ...
                Mantis is feeling the emotions...
              </>
            ) : (
              <>😊 Analyze Sentiment</>
            )}
